...
var config: TileData[] = [
    ...
    { x: 2, y: 10, walkable: true, image: "ground_jpg" },
    { x: 3, y: 10, walkable: true, image: "ground_jpg" },
    { x: 4, y: 10, walkable: true, image: "ground_jpg" },
    { x: 5, y: 10, walkable: true, image: "ground_jpg" },
    { x: 6, y: 10, walkable: false, image: "barrier_jpg" },
    ...
    { x: 2, y: 11, walkable: true, image: "ground_jpg" },
    { x: 3, y: 11, walkable: true, image: "ground_jpg" },
    { x: 4, y: 11, walkable: true, image: "ground_jpg" },
    { x: 5, y: 11, walkable: true, image: "ground_jpg" },
    { x: 6, y: 11, walkable: true, image: "ground_jpg" },
